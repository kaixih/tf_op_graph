...
print_op_graph(
    conv_layerN_grad_relu_model, (n, h, w, c),
    f"layout_pass_layerN_grad_{precision.name}_{socket.gethostname()}.png",
    ['layout'])
