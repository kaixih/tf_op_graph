...
parser.add_argument('--graph0', help="""The first GraphDef file path.""")
parser.add_argument('--graph1', help="""The second GraphDef file path.""")
...
def verify_path(m):
  if m == "" or os.path.isfile(m) and m.lower().endswith(('.pb.txt', '.pbtxt')):
    return True
  return False
...
if gd0_path == "" and gd1_path == "":
  raise ValueError('At least, one of graph0 and graph1 needs to be specified.')
if gd0_path == "":
